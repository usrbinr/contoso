...
Built into the package is the smallest version of the dataset: 7,794 sales
lines across 3,242 orders and 3,165 customers.
...
Using `labelled::look_for()`, you can also see the columns' labels from the
